...
3.1 Type on the Internet browser's address bar https://www.adamson.edu.ph/uee/ for online application.
...
3.7 Print the UEE permit anywhere with internet access after selecting the UEE schedule.
...
5.1.2 Pay at the cash Management Office or any accredited banks or any Bayad Center.
...
5.2.2 Pay at the Cash Management Office, accredited banks or any Bayad Center.
...
5.3.4 Once the account is generated, follow the enrollment procedure for old student.
...
Academic Honor requirements based on General Weighted Average (GWA):
...
• Social Media
• Others (films, movies, video, tapes, CDs, DVDs, Blueray, USB, smart phone and the like).
...
A consortium school is a college that is part of a group of colleges that work together to share resources, facilities, and courses

Subtle Colors in hair include (from Bremod Color Chart):
Natural:
10.0 Lightest Blond
9.0 Lighter blond
8.0 Light Blond
...
7.1 Gray
6.1 Dark Ash Blond
7.31   Light Golden Ash Blond
6.31  Golden Ash Blond
0.19  Ash

Ash Brown:
7.17 Chocolate Brown
6.17 Honey Tea Brown
5.17 Mocha Brown

Green:
8.2 Light Stuffy Green Blonde

For more clarification, see the Bremod Color Chart.

The Bremod Hair Color Chart is a visual representation of the various shades. It categorizes colors into different families such as blonde, brown, red, and fashion shades.
